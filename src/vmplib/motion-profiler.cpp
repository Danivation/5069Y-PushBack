...
#include "vmplib/motion-utils.hpp"       // for sFunction, curvature, findXandY, findTForS, wrapAngle, sinc
#include "vmplib/motion-profiling.hpp"   // TrapezoidalProfile
#include "vmplib/ramsete.hpp"            // RamseteFollower
#include "vmplib/printer.hpp"            // Printer::printPoseVector / printVelocityVector
#include <cmath>
#include <vector>
#include <string>
